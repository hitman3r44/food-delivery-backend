...
import com.wolverinesolutions.domain.PaymentResponse;
import com.wolverinesolutions.domain.entities.Payment;
import com.wolverinesolutions.domain.enums.OrderStatus;
        ...
        authorizationResponse.addCallback(new ListenableFutureCallback<AuthorizationResponse>() {
            ...
            public void onSuccess(AuthorizationResponse authorizationResponse) {
                ...
                ResponseEntity<PaymentResponse> responseEntity =
                        new ResponseEntity<>(paymentResponse, HttpStatus.OK);
                deferredResult.setResult(responseEntity);
            }
        });
